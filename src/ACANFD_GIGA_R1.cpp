...
GPIO_TypeDef * set_GPIO_Port_Clock (const uint32_t inPortIndex) {
  ...
  switch (inPortIndex) {
    case PortA:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOAEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOAEN);
      }
      break;
    case PortB:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOBEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOBEN);
      }
      break;
    case PortC:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOCEN);
        uint32_t x __attribute__((unused)) = READ_BIT (RCC->AHB4ENR, RCC_AHB4ENR_GPIOCEN);
      }
      break;
    case PortD:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIODEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIODEN);
      }
      break;
    case PortE:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOEEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOEEN);
      }
      break;
    case PortF:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOFEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOFEN);
      }
      break;
    case PortG:
...
//       #endif
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOGEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOGEN);
      }
      break;
    case PortH:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOHEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOHEN);
      }
      break;
    case PortI:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOIEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOIEN);
      }
      break;
    case PortJ:
      ...
      { SET_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOJEN);
        uint32_t x __attribute__((unused)) = READ_BIT(RCC->AHB4ENR, RCC_AHB4ENR_GPIOJEN);
      }
      break;
    case PortK:
...
ACANFD_GIGA_R1::ACANFD_GIGA_R1 (volatile FDCAN_GlobalTypeDef * inPeripheralModuleBasePointer,
...
mInterruptConfig (inInterruptConfig),
...
uint32_t ACANFD_GIGA_R1::beginFD (const ACANFD_GIGA_R1_Settings & inSettings,
  ...
  return beginFD (inSettings, ACANFD_GIGA_R1_StandardFilters (), inExtendedFilters) ;
}
...
uint32_t ACANFD_GIGA_R1::beginFD (const ACANFD_GIGA_R1_Settings & inSettings,
                                  const ACANFD_GIGA_R1_StandardFilters & inStandardFilters,
                                  const ACANFD_GIGA_R1_ExtendedFilters & inExtendedFilters) {
  uint32_t errorFlags = inSettings.checkBitSettingConsistency () ;
  NVIC_DisableIRQ (mInterruptConfig.mIRQ0) ;
  NVIC_DisableIRQ (mInterruptConfig.mIRQ1) ;
...
//---------------------------------------------- Configure TxPin
  ...
  while (!pinFound && (idx < mTxPinArray.size ())) {
    pinFound = (mTxPinArray.begin () + idx)->mPinName == inSettings.mTxPin ;
    if (!pinFound) {
      idx += 1 ;
    }
  }
  if (pinFound) {
    GPIO_TypeDef * gpio = set_GPIO_Port_Clock ((mTxPinArray.begin () + idx)->mPinName >> 4) ;
    const uint32_t pinIndex = (mTxPinArray.begin () + idx)->mPinName & 0x0F ;
    ...
    if (pinIndex < 8) {
      LL_GPIO_SetAFPin_0_7 (gpio, txPinMask, (mTxPinArray.begin () + idx)->mPinAlternateMode) ;
    }else{
      LL_GPIO_SetAFPin_8_15 (gpio, txPinMask, (mTxPinArray.begin () + idx)->mPinAlternateMode) ;
    }
...
//---------------------------------------------- Configure RxPin
  ...
  while (!pinFound && (idx < mRxPinArray.size ())) {
    pinFound = (mRxPinArray.begin () + idx)->mPinName == inSettings.mRxPin ;
    if (!pinFound) {
      idx += 1 ;
    }
  }
  if (pinFound) {
    GPIO_TypeDef * gpio = set_GPIO_Port_Clock ((mRxPinArray.begin () + idx)->mPinName >> 4) ;
    const uint32_t pinIndex = (mRxPinArray.begin () + idx)->mPinName & 0x0F ;
    ...
    if (pinIndex < 8) {
      LL_GPIO_SetAFPin_0_7 (gpio, rxPinMask, (mRxPinArray.begin () + idx)->mPinAlternateMode) ;
    }else{
      LL_GPIO_SetAFPin_8_15 (gpio, rxPinMask, (mRxPinArray.begin () + idx)->mPinAlternateMode) ;
    }
...
//------------------------------------------------------ Select mode
  ...
  case ACANFD_GIGA_R1_Settings::NORMAL_FD :
    break ;
  case ACANFD_GIGA_R1_Settings::INTERNAL_LOOP_BACK :
    mPeripheralPtr->TEST = FDCAN_TEST_LBCK ;
    cccr |= FDCAN_CCCR_MON | FDCAN_CCCR_TEST ;
    break ;
  case ACANFD_GIGA_R1_Settings::EXTERNAL_LOOP_BACK :
    mPeripheralPtr->TEST = FDCAN_TEST_LBCK ;
    cccr |= FDCAN_CCCR_TEST ;
    break ;
  case ACANFD_GIGA_R1_Settings::BUS_MONITORING :
    cccr |= FDCAN_CCCR_MON ;
    break ;
  }
...
//--- Allocate Rx FIFO 0 (0 ... 64 elements -> 0 ... 1152 words)
  ...
  messageRAMOffset += inSettings.mHardwareRxFIFO0Size * ACANFD_GIGA_R1_Settings::wordCountForPayload (mHardwareRxFIFO0Payload) ;
...
//--- Allocate Rx FIFO 1 (0 ... 64 elements -> 0 ... 1152 words)
  ...
  messageRAMOffset += inSettings.mHardwareRxFIFO1Size * ACANFD_GIGA_R1_Settings::wordCountForPayload (mHardwareRxFIFO1Payload) ;
...
//--- Allocate Tx Buffers (0 ... 32 elements -> 0 ... 576 words)
  ...
  messageRAMOffset += txBufferCount * ACANFD_GIGA_R1_Settings::wordCountForPayload (mHardwareTxBufferPayload) ;
...
//------------------------------------------------------ Check Message RAM Allocation
  ...
  //------------------------------------------------------ Install interrupt vectors
    uint32_t * it0_vector_address = (uint32_t *) (SCB->VTOR + mInterruptConfig.mIRQ0VectorOffset) ;
    uint32_t * it1_vector_address = (uint32_t *) (SCB->VTOR + mInterruptConfig.mIRQ1VectorOffset) ;
    *it0_vector_address = mInterruptConfig.mIRQ0InterruptRoutineAddress ;
    *it1_vector_address = mInterruptConfig.mIRQ1InterruptRoutineAddress ;
  //------------------------------------------------------ Interrupts
    ...
    NVIC_EnableIRQ (mInterruptConfig.mIRQ0) ;
    NVIC_EnableIRQ (mInterruptConfig.mIRQ1) ;
...
uint32_t ACANFD_GIGA_R1::messageRamRequiredMinimumSize (void) {
...
bool ACANFD_GIGA_R1::availableFD0 (void) {
  noInterrupts () ;
...
bool ACANFD_GIGA_R1::availableFD1 (void) {
  noInterrupts () ;
...
bool ACANFD_GIGA_R1::dispatchReceivedMessage (void) {
...
bool ACANFD_GIGA_R1::dispatchReceivedMessageFIFO0 (void) {
  CANFDMessage message ;
...
bool ACANFD_GIGA_R1::dispatchReceivedMessageFIFO1 (void) {
  CANFDMessage message ;
...
void ACANFD_GIGA_R1::internalDispatchReceivedMessage (const CANFDMessage & inMessage) {
...
bool ACANFD_GIGA_R1::sendBufferNotFullForIndex (const uint32_t inMessageIndex) {
  bool canSend = false ;
  noInterrupts () ;
...
void ACANFD_GIGA_R1::writeTxBuffer (const CANFDMessage & inMessage, const uint32_t inTxBufferIndex) {
//--- Compute Tx Buffer address
  volatile uint32_t * txBufferPtr = mTxBuffersPointer ;
  txBufferPtr += inTxBufferIndex * ACANFD_GIGA_R1_Settings::wordCountForPayload (mHardwareTxBufferPayload) ;
...
//---
  const uint32_t lg = ACANFD_GIGA_R1_Settings::frameDataByteCountForPayload (mHardwareTxBufferPayload) ;
...
static void getMessageFrom (const uint32_t * inMessageRamAddress,
                            const ACANFD_GIGA_R1_Settings::Payload inPayLoad,
                            CANFDMessage & outMessage) {
  const uint32_t lg = ACANFD_GIGA_R1_Settings::frameDataByteCountForPayload (inPayLoad) ;
...
//--- Get messages
  ...
  //--- Get from FIFO 0
    ...
    //--- Compute message RAM address
      ...
      address += readIndex * ACANFD_GIGA_R1_Settings::wordCountForPayload (mHardwareRxFIFO0Payload) ;
    //--- Get message
  ...
  //--- Get from FIFO 1
    ...
    //--- Compute message RAM address
      ...
      address += readIndex * ACANFD_GIGA_R1_Settings::wordCountForPayload (mHardwareRxFIFO1Payload) ;
    //--- Get message
...
uint32_t ACANFD_GIGA_R1::statusFlags (void) const {
...
ACANFD_GIGA_R1::BusStatus::BusStatus (volatile FDCAN_GlobalTypeDef * inModulePtr) :
