...
#include <ACANFD_GIGA_R1_DataBitRateFactor.h>
#include <ACANFD_GIGA_R1_Filters.h>
...
class ACANFD_GIGA_R1_Settings {
  ...
  public: ACANFD_GIGA_R1_Settings (const uint32_t inDesiredArbitrationBitRate,
...
//-- Accept non matching frames ?
  public: ACANFD_GIGA_R1_FilterAction mNonMatchingStandardFrameReception = ACANFD_GIGA_R1_FilterAction::FIFO0 ;
  public: ACANFD_GIGA_R1_FilterAction mNonMatchingExtendedFrameReception = ACANFD_GIGA_R1_FilterAction::FIFO0 ;
